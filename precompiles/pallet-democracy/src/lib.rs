	...
	Runtime::Hash: From<H256>,
{
	...
	// https://github.com/axia-tech/substrate/pull/9565 which has been merged into Substrate
	...
	fn ongoing_referendum_info(
		...
		Err(error(
			"This method depends on https://github.com/axia-tech/substrate/pull/9565",
		))
		// let mut gasometer = Gasometer::new(target_gas);
