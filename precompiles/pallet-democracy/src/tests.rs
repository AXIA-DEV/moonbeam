...
// asked about it in https://github.com/axia-tech/substrate/issues/9739
#[ignore]
#[test]
...
// waiting on https://github.com/axia-tech/substrate/pull/9565
#[ignore]
#[test]
...
fn remove_vote_dne() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			// This will be nicer after https://github.com/axia-tech/substrate/pull/9484
			// Make a proposal
			assert_ok!(Call::Democracy(DemocracyCall::propose {
				proposal_hash: Default::default(), // Propose the default hash
				value: 100u128,                    // bond of 100 tokens
...
fn unlock_works() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			// reflected here?
			// https://github.com/axia-tech/substrate/blob/master/frame/democracy/src/lib.rs#L1405
