...
ROCOCO_SPEC_TEMPLATE_FILENAME=${ROCOCO_SPEC_TEMPLATE_FILENAME:-"betanet-specs-template.json"}
ROCOCO_SPEC_PLAIN_FILENAME=${ROCOCO_SPEC_PLAIN_FILENAME:-"betanet-specs-plain.json"}
ROCOCO_SPEC_RAW_FILENAME=${ROCOCO_SPEC_RAW_FILENAME:-"betanet-specs-raw.json"}

# Generic network declarations
ROCOCO_LOCAL_RAW_SPEC=${ROCOCO_LOCAL_RAW_SPEC:-"$BUILD_FOLDER/betanet-specs-raw.json"}
COMMON_NODE_KEYS=(
...
ALPHANET_PARACHAIN_EMBEDDED_SPEC=${ALPHANET_PARACHAIN_EMBEDDED_SPEC:-"$ALPHANET_SPEC_FOLDER/parachain-embedded-specs-v8.json"}
...
ALPHANET_ROCOCO_EMBEDDED_SPEC=${ALPHANET_ROCOCO_EMBEDDED_SPEC:-"$ALPHANET_SPEC_FOLDER/betanet-embedded-specs-v8.json"}
...
ALPHANET_ROCOCO_SPEC_TMP=${ALPHANET_ROCOCO_SPEC_TMP:-"$ALPHANET_TMP_FOLDER/betanet-tmp-spec.json"}
...
ALPHANET_STAKERS=($(jq -r '.genesis.runtime.parachainStaking.candidates[] | .[0]' ${ALPHANET_PARACHAIN_SPEC_TEMPLATE}))
